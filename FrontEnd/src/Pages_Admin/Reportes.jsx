  ...
  const Reportes = () => {
    ...
    const handleGenerateReport = async () => {
      ...
      if (tipoReporte === "mensual" && (!anio || !mes)) {
        alert("Por favor ingresa un año y un mes válidos para generar el reporte mensual.");
        return;
      }
  
      if (tipoReporte === "diario" && !fecha) {
        alert("Por favor selecciona una fecha válida para generar el reporte diario.");
        return;
      }
      ...
      try {
        ...
        switch (tipoReporte) {
          case "anual":
            endpoint = "/reporte_anual.php";
            payload = { anio };
            break;
          case "mensual":
            endpoint = "/reporte_mensual.php";
            payload = { anio, mes };
            break;
          case "diario":
            endpoint = "/reporte_diario.php";
            payload = { fecha_reporte: fecha };
            break;
          case "rango":
            endpoint = "/reporte_fechas.php";
      ...
      <div className="reportes-wrapper">
        <div className="card">
          <div className="card-header">
            <h2 className="card-tit">Reportes de Ingresos</h2>
          </div>
          ...
          <div className="card-conte">
            ...
            {pdfUrl && (
              <div className="pdf-preview">
                <iframe src={pdfUrl} title="Previsualización del reporte" width="100%" />
                <a href={pdfUrl} download={`reporte_ingresos_${tipoReporte}.pdf`}>
