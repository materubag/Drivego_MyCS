...
$sql_count = "SELECT COUNT(*) AS total_reportes
              FROM reservas r
              WHERE EXTRACT(YEAR FROM r.fec_res) = :anio AND EXTRACT(MONTH FROM r.fec_res) = :mes AND r.metodo_pago IS NOT NULL";
...
$sql = "SELECT r.id_res, r.nom_usu_res, r.matricula_veh, v.mar_veh, v.mod_veh, v.precio_veh, r.fec_res, r.fec_dev, r.tar_adi
        ...
        WHERE EXTRACT(YEAR FROM r.fec_res) = :anio AND EXTRACT(MONTH FROM r.fec_res) = :mes And r.met_pag IS NOT NULL";
